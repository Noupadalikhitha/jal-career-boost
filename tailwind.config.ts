  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        poster: {
          primary: "hsl(var(--poster-primary))",
          secondary: "hsl(var(--poster-secondary))",
          accent: "hsl(var(--poster-accent))",
          dark: "hsl(var(--poster-dark))",
        },
        sidebar: {
      ...
      keyframes: {
        ...
        "wave-reverse": {
          "0%": { transform: "translateX(100vw) translateY(-5px)" },
      ...
      animation: {
        ...
        "float-fish": "float-fish 6s ease-in-out infinite",
